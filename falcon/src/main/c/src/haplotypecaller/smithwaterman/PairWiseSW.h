...
int32_t CONCAT(runSWOnePairBT_,SIMD_ENGINE)(int32_t match, int32_t mismatch, int32_t open, int32_t extend,uint8_t *seq1, uint8_t *seq2, int32_t len1, int32_t len2, int8_t overhangStrategy, struct Cigar* cigarRet, struct sw_ptrs ptrs)
{

    int32_t* E_ = ptrs.E_;
    int16_t* backTrack_ = ptrs.backTrack_;
    int16_t* cigarBuf_ = ptrs.cigarBuf_;
